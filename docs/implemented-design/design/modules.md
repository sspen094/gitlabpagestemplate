...
Ownership areas of the product. Slices deliver features inside a module.

| Module id | Purpose | Features |
|-----------|---------|----------|
| platform | App host, Vite build, GitHub Pages | [app-scaffold](../../modules/platform/features/app-scaffold/README.md) |
