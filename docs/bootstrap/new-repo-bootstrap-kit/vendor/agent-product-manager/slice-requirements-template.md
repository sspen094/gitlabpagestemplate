...
**Target database (intent):** _`CIDashboard` — where **owned tables** live; justify by data domain; omit if no SQL_  
...
5. **Execute** pytest, flow scripts, and UI smoke as applicable  
...
- Architecture: `docs/requirements/vision/mfgcidashboard_architecture_for_cursor.md`
- UI spec: `docs/requirements/vision/mfgcidashboard_ui_spec_for_cursor.md` _(when UI exists)_
