...
| **Module** | Long-lived ownership area | `src/mfgcidashboard_app/modules/<module_id>/` |
| **Feature** | One capability (kebab-case) | `…/modules/<module_id>/<feature>/` |
...
Sync docs/project-files/project-plan/slices/NN-name-tasks.md including:
  ...
  regression-plan rows, execute pytest/smoke, as-built docs.
