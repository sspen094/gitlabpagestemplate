...
Regression pytest and flow scripts live under **`tests/`** — see `tests/SCAFFOLD.md` and `docs/project-files/regression/regression-plan.md`.

**Do not** put verification checklists in `tests/` — they are not pytest modules.
