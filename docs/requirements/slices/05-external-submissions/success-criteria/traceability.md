...
|----|---------------------|-------|-------|------------------|--------|----------|
| 1 | Submissions via email/external only | SC-01 | 1 | Unit/component adapter-only submit test | planned | — |
| 2 | No site-side storage of submissions | SC-02 | 1 | Code review + no-storage test | planned | — |
| 3 | Working example form, graceful states | SC-03 | 2 | Component validation/success/failure test | planned | — |
